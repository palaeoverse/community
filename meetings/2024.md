...
### Packages
palaeoverse (Lewis):  
- tax_range_time/strat grouping (Bethany)

  - Aiming for merging by end of January
- tax_certainty (Bruna)

  - Still figuring out making something official like this
  - Response to reviews is done; working on fixing tests
  - Lewis will take a look
  - Aiming for merging by end of January
...
rmacrostrat (Lewis):  
- Macrostrat API updates

  - Lewis has been in back-and-forth with Macrostrat staff; package still works so far...
...
- Applying for a sizable 2-3 year grant to run workshops and further develop open science resources in palaeontology (https://new.nsf.gov/funding/opportunities/geo-ose-geosciences-open-science-ecosystem/nsf25-506/solicitation)
  ...
  - End-to-end open science would include 1) a shiny app that teaches people palaeo data cleaning and data analyis in R, 2) teaching workshops on palaeoverse and other palaeo R packages, and 3) promoting Open Palaeontology
  - Submitting grant proposal late next year, reach out to Will to be involved
- Would fund a postdoc(!) that would work (~50%) on shiny app and OPal and plan workshops (a la Paleosynthesis)

NIH Data Sharing Metric Challenge (Will):
- NIH has set a challenge to come up with a metric for measuring the impact of data sharing (https://www.challenge.gov/?challenge=nih-data-sharing-index-s-index-challenge&tab=overview)
- First prize is $500,000! ($300,000 and $100,000 for 2nd and 3rd prize)
- Competition opens in April

PAGES (Erin and Lewis):  
- Group endorsements

  - Would fast-track us to getting funding, but would also make us report to PAGES, so not sure...
- Event endorsements
- Workshop sponsorship

### Events
Lecture series (Lewis):
...
- Hoping to get some funding for this, maybe the Geological Society or PS since the last funding came from PalAss
...
-	Resource page added
  ...
  -	Please add more resources! (ask Chris for a link to the spreadsheet)
...
- Bluesky
  ...
  - Start investing more energy in this, although no easy way to delegate access
- X
  - Invest less energy in this over time, although still plenty of followers and activity there
...
-	Rules sections already allocated for writing, ideally have a draft before the meeting above.
-	Paper evaluation
  
### Next meeting
2025-01-09, 14:00 UTC
...
### Packages
palaeoverse (Lewis):  
- Active PRs - timeline for completion
  - End of January active PRs deadline (Bruna, Bethany)
- Future of palaeoverse
  -	Original vision to have users be able to contribute to package; has meant less interaction between functions – is simpler for users, but can be more time consuming for updates/bugs/etc.
  -	Do we still want to push for community input? If yes, how do we do this/balance the trade off with code maintenance?
  -	Will suggested contacting those who said they worked with relevant packages and such to expand the package.
  -	We might reconsider how clearly we are advertising for people to be involved, what benefits they might get etc. (e.g., new members won’t get cited for palaeoverse as usually just the ME&E paper cited).
  -	Needs to have a future discussion/focus group on this.
 

rphylopic (Will):  
- Nothing of note (other than an annoying dependency-induced bug!)
  - Nothing to report

rmacrostrat (Lewis):  
- Manuscript now published - yipee!

sepkoski (Lewis):  
- Updates continue...

### Open Palaeontology
-	Hopefully open for submissions by PalAss 2024!
-	Always get in touch if interested or even just have any suggestions/complaints about publishing in palaeo.
-	JOSS also has a call for editors.

### Events
Lecture series (Erin)  
-	Still reduced numbers, ~50% of previously.
-	Might want to look at advertising in future regarding social media. Harrie is going to start including it in the PalAss monthly newsletter, and it is already in the PalSoc monthly too. Do we also want to advertise on platforms like bluesky (we already have an account, so yes on this) or Instagram?
-	Bethany will share bluesky account details and check on two-factor.
-	Do we want to advertise on PAGES? We should look into everywhere palaeo-related that we can.
  
CPEG workshop (Erin)  
-	February-time ish to start preparing resources. Erin in charge, will reach out in new year. 
-	No funding for workshop but there will be lots of wavers for the meeting available, etc.
-	Early bird registration free for PhDs and postdocs until April 1st 2025.

GSA workshop (Will)  
-	Still no confirmation of go-ahead, Will has reminded contact and they will remind executive committee who make decision.

Greenman Festival Outreach (Chris):
-	Waiting until the new year, as a bit too early at present.
-	We would have to apply for funding separately – booth cost, tickets, travel etc.
-	Time to start thinking of ideas, plus contact Chris if interested.
-	Chris emailed Blue Dot Festival too, with high-profile science talks, which we might be able to do something in. Not heard back yet, or even if festival running.

### Resources

Materials:  
-	Miranta working on organisation logo, Lewis to circulate for comments
-	Cheat sheets in progress. Should be able to c/p into google slides template from Miranta (see Slack). 

Website (Lewis):  
-	Lewis updating website with new members, resource page outstanding.
...
### Projects
Using R in palaeobiology: a review of recent developments and future directions/What has R done for palaeobiology? (Will):  
-	CRAN task view done but needs to be approved by editors still.
-	This will then be the framework for the paper.

10 rules for data cleaning (Lewis):
- Meeting: 2024-11-15, 14:00 UTC
-	Rules sections already allocated for writing, ideally have a draft before the meeting above.
  
### Next meeting
2024-12-05, 14:00 UTC

### A.O.B.
-	Submit first article for a new palaeoverse column (a few issues +) in the PalAss Newsletter. Be good to set up a short chat to decide on how we want to focus this (vignettes, specific packages, introductory article looking at community impact, etc.?) and decide responsibilities. Deadline for manuscript some time in January.
-	Interested new members: [omitted]. Circulate on slack to have a look about whether they would be appropriate.
